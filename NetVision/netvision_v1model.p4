...
control MyEgress(inout headers hdr,
    ...
    action add_enq_qdepth_header() {
        ...
        meta.enq_qdepth.enq_qdepth = (bit<16>)standard_metadata.enq_qdepth;
    ...
    action add_deq_qdepth_header() {
        ...
        meta.deq_qdepth.deq_qdepth = (bit<16>)standard_metadata.deq_qdepth;
    ...
    action tmy_inst_complete() {
        hdr.fwd_header.proto = PROTO_TMY_DATA;
    }
